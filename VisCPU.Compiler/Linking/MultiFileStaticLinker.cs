...
namespace VisCPU.Compiler.Linking
{
    ...
    public class MultiFileStaticLinker : Linker
    {
        ...
        {
            Dictionary<FileReference, LinkerTarget> allLinkerTargets = new Dictionary<FileReference, LinkerTarget>();
        ...
        private void RecursiveDiscoverCompilationTree(
            LinkerTarget root, Dictionary<FileReference, LinkerTarget> targets)
        {
        ...
        private LinkerResult ProcessOrdered(
            LinkerTarget root, Dictionary<FileReference, LinkerTarget> mapping, bool enableHide)
        {
        ...
        private void JoinDefinitions(
            IDictionary<string, AddressItem> dst, IDictionary<string, AddressItem> src, bool enableHide)
        {
            int hiddenItems = 0;
            int exportedItems = 0;
