...
namespace VisCPU.Console.Core.Subsystems.Modules
{
    ...
    public class ProjectPublishSubSystem : ConsoleSubsystem
    {
        ...
        public static void Publish(string root, PublishOptions publishOptions, ProjectPackSubSystem.PackOptions packOptions)
        {
            ...
            ProjectInfo t = ModuleManager.LoadModuleTarget(src);
        ...
        public override void Help()
        {
            ...
            HelpSubSystem.WriteSubsystem( "vis project publish <repo> <projectDir>" , new ProjectPackSubSystem.PackOptions(), new PublishOptions());
        }
