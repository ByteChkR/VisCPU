...
namespace VisCPU.HL.Parser
{
    ...
    public static class HLParsingTools
    {
        ...
        public static bool ReadNoneOrAnyOf(
            List<IHLToken> tokens, int start, HLTokenType[] type, out IHLToken result)
        {
        ...
        public static IHLToken[] ReadOneOrManyOf(
            List<IHLToken> tokens, int start, int step, HLTokenType[] type)
        {
        ...
        /// <param name="type">Accepted Types</param>
        /// <returns>Read Tokens</returns>
        public static IHLToken[] ReadNoneOrManyOf(
            List<IHLToken> tokens, int start, int step, HLTokenType[] type)
        {
