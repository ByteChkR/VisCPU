...
namespace VisCPU.HL.Parser
{
    ...
    public class HLTokenReadException : Exception
    {
        ...
        public HLTokenReadException(
            IEnumerable<IHLToken> tokenSequence, HLTokenType[] expected, HLTokenType unmatched, int start) :
        ...
        /// <param name="start">Start index in source</param>
        public HLTokenReadException(
            IEnumerable<IHLToken> tokenSequence, HLTokenType expected, HLTokenType unmatched,
            int start) : this(
                              tokenSequence,
                              new[] { expected },
                              unmatched,
