...
namespace VisCPU.Tests
{
    ...
    public class FunctionCompileTest : VisCPUCompileTest
    {
        ...
        [Test, Order(1), TestCaseSource(nameof(GetTestExpressionInstructions), new object[] { "tests/function_calls" })]
        public void CompileHL(string file)
        {
            VHL2VASM(file);
        }

        [Test, Order(2), TestCaseSource(nameof(GetTestAssemblyInstructions), new object[] { "tests/function_calls" })]
        public void CompileVASM(string file)
        {
            VASM2VBIN(file);
        }

        [Test, Order(3), TestCaseSource(nameof(GetTestBinaryInstructions), new object[] { "tests/function_calls" })]
