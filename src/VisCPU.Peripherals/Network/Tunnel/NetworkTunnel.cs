...
namespace VisCPU.Peripherals.Network
{
    public class NetworkTunnel : NetworkBase
    {
        ...
        private bool m_Exit;
        private readonly ConcurrentDictionary<int, object> m_RemoteAdapters = new ConcurrentDictionary<int, object>();

        public bool IsRunning => m_Thread != null && m_Thread.IsAlive;
        public System.Net.EndPoint Endpoint => m_Client.Client.RemoteEndPoint;
        public int[] GetRemoteAdapters() => m_RemoteAdapters.Keys.ToArray();
