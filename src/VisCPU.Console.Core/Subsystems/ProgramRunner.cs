...
namespace VisCPU.Console.Core.Subsystems
{
    ...
    public class ProgramRunner : ConsoleSubsystem
    {
        ...
        public static Cpu Create(IEnumerable<string> args, CpuSettings cpuSettings = null, RunnerSettings settings = null, HlCompilerSettings hls = null, MemorySettings ms = null, MemoryBusSettings mbs = null)
        {
