...
namespace Utility.ExtPP.Base
{
    ...
    public static class PropertyHelper < T >
    {
        ...
        public static FieldInfo GetFieldInfo < TValue >( Expression < Func < T, TValue > > selector )
        {
        ...
        private static MemberInfo GetMemberInfo < TValue >( Expression < Func < T, TValue > > selector )
        {
