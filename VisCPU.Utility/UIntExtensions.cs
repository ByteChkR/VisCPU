...
namespace VisCPU.Utility
{
    ...
    public static class UnityIsAPieceOfShitHelper
    {
        ...
        public static void SetAppDomainBase() => SetCustomBase(AppDomain.CurrentDomain.BaseDirectory);
        public static void SetCustomBase(string baseDir) => AppRoot = baseDir;
    }
